...
public class GooglePurchase
{
	...
	private string _packageName_k__BackingField;

	private string _orderId_k__BackingField;

	private string _productId_k__BackingField;

	private string _developerPayload_k__BackingField;

	private string _type_k__BackingField;

	private long _purchaseTime_k__BackingField;

	private GooglePurchase.GooglePurchaseState _purchaseState_k__BackingField;

	private string _purchaseToken_k__BackingField;

	private string _signature_k__BackingField;

	private string _originalJson_k__BackingField;
